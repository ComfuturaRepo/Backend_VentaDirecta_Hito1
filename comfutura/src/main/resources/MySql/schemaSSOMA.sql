/* =====================================================
   ...
   - PETAR (Permisos Alto Riesgo)
===================================================== */

CREATE DATABASE IF NOT EXISTS sst_db;
USE sst_db;


-- =====================================================
-- 1. TABLAS GENERALES / REUTILIZABLES
-- =====================================================

/*
 Guarda la firma digital (imagen)
 Se reutiliza en todas las hojas
*/
CREATE TABLE firma (
...
/*
 Personas que participan en todo el sistema
 (trabajadores, supervisor, SOMA, brigadista, etc.)
*/
...
/*
 Rol que cumple el trabajador dentro del documento
 Ej: Supervisor, SOMA, Responsable, Participante
*/
